document.addEventListener("DOMContentLoaded", function() {
    ...
    function changeEnglish() {
        ...
        document.getElementById("subtitle-one-landing").textContent = "Be part of my professional history!";
    ...
    function changeSpanishl() {
        ...
        document.getElementById("subtitle-one-landing").textContent = "¡Sé parte de mi historia profesional!";
